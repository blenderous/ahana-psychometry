    ...
    <Router>
      <div className="container">
          ...
          <Switch>
              ...
              <Route exact  path='/ahana-psychometry/edit/:id' component={ Edit } />
              <Route exact  path='/ahana-psychometry/index' component={ Index } />
              <Route exact  exact path='/ahana-psychometry/' component={ Home } />
              <Route exact  exact path='/ahana-psychometry/assessments/' component={ Assessments } />
