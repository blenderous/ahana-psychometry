            ...
            <div className="vertically-center-outer">
                <div className="vertically-center-middle">
                    <div className="vertically-center-inner">
                        ...
                        <p className="text-below-search-bar"><Link to={'/ahana_psychometry/create'}>Proceed to Asssessments</Link></p>
                    </div>
                </div>
                <a href="/ahana_psychometry/" className="logo-link"><img src="/logo-ahana.png" alt="Ahana : Experience the exceptional care"/></a>
            </div>
        )
    }
}